...
interface RetailerConfig {
  /** The hostname to match (e.g., 'amazon.in'). */
  hostname: string;
  /** The slug used in the CashKaro URL (e.g., 'amazon'). */
  slug: string;
  /** A function to validate if a URL is a product page and not a search/category page. */
 ...
 */
export const AFFILIATE_RETAILERS: RetailerConfig[] = [
  {
    hostname: 'amazon.in',
    slug: 'amazon',
    isProductPage: (url: URL): boolean => {
