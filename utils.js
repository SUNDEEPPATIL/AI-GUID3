 ...
 */
export const findBestRetailerPrice = (prices) => {
 ...
 */
export const findBestValueProduct = (products) => {
 ...
 */
export const findBestPerformanceProduct = (products) => {
    if (!products || products.length === 0) {
        return null;
    }
 ...
 */
const createRetailerSearchLink = (retailer, product) => {
 ...
 */
export const createPurchaseLink = (retailer, product) => {
